...
Blockly.Msg.CONTROLS_FOREACH_TITLE = "为每个变量 %1 在数组中 %2";
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "遍历每个数组中的变量，将变量“%1”设定到该项中，然后执行某些语句。";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "循环直到";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "循环当";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TITLE = "创建空数组";
...
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "建立字符串使用";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "将一个项添加到数组中。";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "建立一个具有任意数量变量的数组。";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "返回数组中的第一个变量。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "返回在数组中的指定位置的项。#1是最后一项。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START = "返回在数组中的指定位置的项。#1是第一个变量。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "返回数组中的最后一项。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "随机返回数组中的一个变量。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "移除并返回数组中的第一个变量。";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST = "移除并返回数组中的最后一个变量。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM = "移除并返回数组中的一个随机变量中。";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST = "设置数组中的第一个变量。";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM = "设置数组中一个随机的变量。";
Blockly.Msg.LISTS_SPLIT_HELPURL = "https://github.com/google/blockly/wiki/Lists#splitting-strings-and-joining-lists";
Blockly.Msg.LISTS_SPLIT_LIST_FROM_TEXT = "从文本制作数组";
Blockly.Msg.LISTS_SPLIT_TEXT_FROM_LIST = "从数组拆出文本";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN = "加入文本数组至一个文本，由分隔符分隔。";
...
Blockly.Msg.MATH_ONLIST_OPERATOR_MODE = "数组中的众数";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "运行用户定义的函数“%1”，并使用它的返回值。";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "建立函数";
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "创建一个不带返回值的函数。";
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL = "https://zh.wikipedia.org/wiki/子程序";
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "返回值";
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "创建一个有返回值的函数。";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TITLE = "参数名称：";
